        ...
        if (this.Get('chart.ylabels')) {
            ...
            if (this.Get('chart.xaxispos') == 'center') {
                ...
                if (this.Get('chart.ymin')) {
                    RGraph.Text(context, font, text_size, xPos, canvas.height - gutter, RGraph.number_format(this, this.Get('chart.ymin'), units_pre, units_post), 'center', align);
                }
            }
        }
        ...
        */
        ...
        for (var j=0; j<this.data[i].length; ++j) {
            ...
            */
            ...
            var color  = RGraph.ResolveColors(this, data_point[j][2] ? data_point[j][2] : default_color);
