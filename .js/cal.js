$(document).ready(function(){
  ...
  function createControls() {  
    var html = '';
    html += "<table class=dt_table>";
    html += "<tr><td class=dt_content>Date:&nbsp;<input class=dt_input id=ts_sdate type=text maxlength=10>"; 
    ...
    html += "&nbsp;&nbsp;TZ offset:&nbsp;<input class=dt_input id=ts_offset type=text value=0 disabled>";
    html += "</td><tr></table>";
    $('#cal').after(html);
  }
  ...
  for (var n = 0; n <= 11; n++) {
    ...
    if (n == 11) {
      ...
      html += "<td id=cog class=cog><img src=.css/cog.png></td>"
    }
  }
